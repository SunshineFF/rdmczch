...
*/
    ...
    var $config = array(
        'appid' => "wx3e080db0119a9e4b",    /*微信开放平台上的应用id*/
        'mch_id' => "1436912002",   /*微信申请成功之后邮件中的商户id*/
        'api_key' => "lsjITei3J3d4UYcCn3k0Mq0000002016",    /*在微信商户平台上自己设定的api密钥 32位*/
        'notify_url' => 'http://505coder.com/index.php/WXAPI/Pay/wxCallback.html' /*自定义的回调程序地址id*/
    );
