...
//        $c3 = M('Comment')->where("goods_id = $goods_id and parent_id = 0 and  ceil(goods_rank) in(1,2)")->count(); // 差评
       $c1 = M('Comment')->where("goods_id = $goods_id  and  ceil(goods_rank) in(4,5) and deleted = 0")->count(); // 好评
       $c2 = M('Comment')->where("goods_id = $goods_id  and  ceil(goods_rank) in(3) and deleted = 0")->count(); // 中评
       $c3 = M('Comment')->where("goods_id = $goods_id  and  ceil(goods_rank) in(1,2) and deleted = 0")->count(); // 差评
